    ...
    <form action="{{ route('advertisements.update', $advertisement->id) }}" method="POST" class="space-y-4 pb-8" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-2 max-w-[560px]">
                ...
                <div>
                    <x-input
                        type="text" class="w-full" name="name" value="{{ $advertisement->name }}"
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-2 max-w-[560px]">
                ...
                <div>
                    <x-input
                        type="text" class="w-full" name="owner_name" value="{{ $advertisement->owner_name }}"
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-2 max-w-[560px]">
                ...
                <div class="flex items-center">
                    <div class="flex-1">
                        <x-input
                            type="text" name="owner_phone" value="{{ $advertisement->owner_phone }}" dir="ltr"
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-2 max-w-[560px]">
                ...
                <x-select name="business_field_id" value="{{ $advertisement->business_field_id }}" display="{{ $advertisement->businessField->name }}" placeholder="{{ __('actions.select.placeholder') }}">
