<x-app-layout>
    <x-slot name="header" class="py-6">
        {{ __('page.packages.edit.header', ['package' => $package->name]) }}
    </x-slot>

    <form action="{{ route('packages.update', $package->id) }}" method="POST" class="space-y-4 pb-8">
        @csrf
        @method('PATCH')
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-1">
                ...
                <x-input
                    type="text" class="w-full mt-1" name="name" value="{{ $package->name }}"
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center space-s-4 text-sm text-slate-500">
                                                        <input
                                                            ...
                                                            {{ in_array($feature->id, $package->features->pluck('id')->toArray()) ? 'checked' : '' }}
                                                        >
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-1">
                ...
                <x-input
                    type="text" class="w-full mt-1" name="price" value="{{ $package->price / 100 }}"
