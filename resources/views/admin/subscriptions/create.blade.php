        ...
        <div class="grid grid-cols-2">
            <div class="col-span-2 max-w-[560px]">
                <div class="flex items-center justify-between">
                    ...
                    <x-actions.add href="{{ route('clients.create', ['redirect' => 'subscriptions.create']) }}"
                                   size="p-1"/>
                </div>

                <x-select name="client_id" value="{{ old('client_id') }}"
            ...
            <div class="col-span-2 max-w-[560px]">
                ...
                <x-select name="package_id" placeholder="{{ __('page.subscriptions.form.package.placeholder') }}">
                    @foreach ($packages as $package)
                        <li class="text-gray-800 text-sm hover:bg-slate-50 cursor-pointer select-none py-2 ps-3 pe-9"
                            role="option"
