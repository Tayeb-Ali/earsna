<x-app-layout>
    ...
    <form action="{{ route('halls.booking-times.store', Session::get('hall')->id) }}" method="POST" class="space-y-4">
        @csrf
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-1">
                ...
                <x-select id="period" name="period" placeholder="{{ __('actions.select.placeholder') }}">
            ...
            <div class="col-span-1">
                <div class="grid grid-cols-2 gap-x-6">
                    ...
                    <div class="col-span-1">
                        ...
                        <input
                            type="text" id="from" name="from" placeholder="{{ __('page.bookingTimes.form.from.placeholder') }}"  readonly="readonly"
                    ...
                    <div class="col-span-1">
                        ...
                        <input
                            type="text" id="to" name="to" placeholder="{{ __('page.bookingTimes.form.to.placeholder') }}" readonly="readonly"
                            class="time-pickers flatpickr flatpickr-input w-full bg-white placeholder-slate-300 rounded-sm text-sm shadow-sm border-none outline-none focus:outline-none focus:ring-0 mt-2"
                            data-id="multipleCustomConjunction"
                        >
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-1">
                ...
                <x-input
                    type="text" id="price" name="price" class="w-full" value="{{ old('price') }}"
