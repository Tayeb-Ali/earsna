<x-app-layout>
    ...
    <form x-data action="{{ route('halls.bookings.update', ['hall' => Session::get('hall')->id, 'booking' => $booking->id]) }}" method="POST" class="pb-8">
        @csrf
        @method('PATCH')
                ...
                <div class="grid grid-cols-3 gap-x-2 items-end">
                    ...
                    <div class="col-span-1">
                        <button
                            ...
                            @click.prevent="$store.bookingTimes.fetch({{ Session::get('hall')->id }})"
                        >
