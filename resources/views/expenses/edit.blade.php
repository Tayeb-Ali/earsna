<x-app-layout>
    <x-slot name="header" class="py-6">
        {{ __('page.expenses.edit.header', ['expense' => $expense->id]) }}
    </x-slot>

    <form action="{{ route('expenses.update', $expense->id) }}" method="POST" class="space-y-4 pb-8">
        @csrf
        @method('PATCH')
            ...
            <div class="col-span-1">
                <div class="grid grid-cols-3 gap-x-6">
                    ...
                    <div class="col-span-1">
                        ...
                        <input
                            type="text" id="date" name="date" value="{{ $expense->date }}" placeholder="{{ __('page.expenses.form.date.placeholder') }}"
                    ...
                    <div class="col-span-1">
                        ...
                        <x-select name="payment_method" value="{{ $expense->payment_method }}" display="{{ __('page.expenses.form.payment_method.items.' . $expense->payment_method) }}" placeholder="{{ __('page.expenses.form.payment_method.placeholder') }}">
                    ...
                    <div class="col-span-1">
                        ...
                        <x-input
                            type="text" class="w-full" name="amount" value="{{ $expense->amount }}"
        ...
        <div class="grid grid-cols-2">
            <div class="col-span-1">
                ...
                <x-textarea name="description" value="{{ $expense->description }}" :placeholder="__('page.expenses.form.description.placeholder')" />
