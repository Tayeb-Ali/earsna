    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        @if (Auth::user()->isClient() && session()->has('hall'))
            <div class="pt-2 pb-3 space-y-1">
                <!-- begin::Dashboard -->
                @can('view dashboard')
                    <x-responsive-nav-link :href="route('halls.dashboard', Session::get('hall')->id)" :active="request()->route()->named('halls.dashboard')" :border="app()->getLocale() === 'ar' ? 'border-r-4' : 'border-l-4'">
                ...
                <!-- begin::Bookings -->
                @can('view bookings')
                    <x-responsive-nav-link :href="route('halls.bookings.index', Session::get('hall')->id)" :active="request()->route()->named('halls.bookings.index')" :border="app()->getLocale() === 'ar' ? 'border-r-4' : 'border-l-4'">
                        {{ __('sidebar.bookings') }}
                    </x-responsive-nav-link>
                @endcan
                <!-- end::Bookings -->
                ...
                <!-- begin::Customers -->
                @can('view customers')
                    <x-responsive-nav-link :href="route('halls.customers.index', Session::get('hall')->id)" :active="request()->route()->named('halls.customers.index')" :border="app()->getLocale() === 'ar' ? 'border-r-4' : 'border-l-4'">
                ...
                <!-- begin::Settings -->
                @can('view settings')
                    <x-responsive-nav-link :href="route('halls.settings', ['hall' => Session::get('hall')->id])" :active="request()->route()->named('halls.settings')" :border="app()->getLocale() === 'ar' ? 'border-r-4' : 'border-l-4'">
                        {{ __('sidebar.settings') }}
                    </x-responsive-nav-link>
                @endcan
                <!-- end::Settings -->
